...
import { exportSimuladoToDocx } from '../../../services/exportService';
                                    ...
                                    return (
                                        <div key={q.id} className="bg-white p-4 rounded-xl border border-slate-200 hover:border-indigo-300 transition-all shadow-sm group">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <button onClick={() => setPreviewQuestion(q as EnemQuestion)} className="text-slate-300 hover:text-indigo-500 transition-colors">
                                                    <BookOpen size={18} />
                                                </button>
                                            </div>
                                            <div
                                                className="cursor-pointer"
                                                onClick={() => setPreviewQuestion(q as EnemQuestion)}
                                            >
