    ...
    const renderActiveSection = () => {
        switch (activeSection) {
            ...
            case 'teacher_evaluations':
                return <Section7TeacherEval onSave={() => handleSaveSection('teacher_evaluations' as keyof PDIProfileData)} />;
            default:
                return <Section1Institutional onSave={() => handleSaveSection('institutional')} />;
        }
    };
            ...
            <FormProvider {...methods}>
                ...
                <main className="flex-1 flex flex-col h-full overflow-hidden">
                    ...
                    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shadow-sm">
                        <div>
                            <span className="text-xs font-black text-slate-400 uppercase tracking-widest">Plano de Desenvolvimento Individual</span>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button onClick={() => navigate(-1)} className="px-4 py-2 text-slate-500 hover:bg-slate-100 rounded-lg text-sm font-bold">
                                Voltar
                            </button>
                        </div>
                    </header>
                    ...
                    <div className="flex-1 overflow-y-auto p-8 md:p-12 scroll-smooth">
                        ...
                        <div className="max-w-4xl mx-auto mt-8 text-center opacity-50">
                            <img src="/logo-profeplan.png" className="h-8 mx-auto mb-2 grayscale" alt="Profeplan" />
                            <p className="text-[10px] uppercase font-black tracking-widest text-slate-400">Documento Oficial • Confidencial</p>
                        </div>
                    </div>
                </main>
            </FormProvider>
