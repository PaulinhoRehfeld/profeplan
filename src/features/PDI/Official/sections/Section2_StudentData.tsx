...
export const Section2StudentData: React.FC<SectionProps> = ({ onSave }) => {
    const { register, formState: { errors } } = useFormContext<PDIProfileData>();
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2 space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Nome do Estudante <span className="text-red-500">*</span></label>
                    <input
                    ...
                    />
                    {errors.student_data?.name && <span className="text-xs text-red-500 font-bold">{errors.student_data.name.message}</span>}
                </div>

                <div className="space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Data de Nascimento</label>
                    <input
                ...
                <div className="space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Idade (Anos)</label>
                    <input
                ...
                <div className="space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Ano de Escolaridade</label>
                    <select
                ...
                <div className="space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Turma</label>
                    <input
                ...
                <div className="space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Turno</label>
                    <select
                ...
                <div className="md:col-span-2 space-y-2">
                    <label className="block text-xs font-bold uppercase text-slate-500 tracking-wider">Professor(a) de Referência / Regente</label>
                    <input
