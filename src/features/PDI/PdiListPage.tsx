                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border ${getStatusColor(pdi.status)}`}>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-xs">
                                        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${pdi.blocks_completed.block_1_8 ? 'bg-green-50 text-green-700' : 'bg-slate-50 text-slate-500'}`}>
                                            {pdi.blocks_completed.block_1_8 ? <CheckCircle size={14} /> : <Clock size={14} />}
                                            <span className="font-semibold">Base 1-8</span>
                                        </div>
                                        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${pdi.blocks_completed.block_9 ? 'bg-green-50 text-green-700' : 'bg-slate-50 text-slate-500'}`}>
                                            {pdi.blocks_completed.block_9 ? <CheckCircle size={14} /> : <Clock size={14} />}
                                            <span className="font-semibold">Plano 9</span>
                                        </div>
                                        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${pdi.blocks_completed.block_10 ? 'bg-green-50 text-green-700' : 'bg-slate-50 text-slate-500'}`}>
                                            {pdi.blocks_completed.block_10 ? <CheckCircle size={14} /> : <Clock size={14} />}
                                            <span className="font-semibold">Aval. 10</span>
                                        </div>
                                        <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${pdi.blocks_completed.block_11 ? 'bg-green-50 text-green-700' : 'bg-slate-50 text-slate-500'}`}>
                                            {pdi.blocks_completed.block_11 ? <CheckCircle size={14} /> : <Clock size={14} />}
