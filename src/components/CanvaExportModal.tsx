            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-purple-50 to-indigo-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-slate-900 tracking-tight">Exportação para Canva</h2>
                            <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">Bulk Create Data</p>
                        </div>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-8 bg-slate-50/50">
                    ...
                    <div className="mb-8 p-6 bg-blue-50 border border-blue-100 rounded-2xl flex gap-6">
                        ...
                        <div className="space-y-2">
                            <h3 className="font-black text-blue-900 text-sm uppercase tracking-wide">Como criar slides em segundos:</h3>
                            <ol className="list-decimal list-inside text-sm text-blue-800 space-y-1 font-medium">
                                <li>Abra um template de apresentação no <strong>Canva</strong>.</li>
                                <li>No menu lateral, vá em <strong>Apps</strong> e busque por <strong>"Criar em Lote" (Bulk Create)</strong>.</li>
                                <li>Selecione <strong>"Inserir dados manualmente"</strong>.</li>
                                <li>Limpe a tabela de exemplo e <strong>COLE</strong> os dados abaixo (clique no botão copiar).</li>
                                <li>Conecte os dados aos elementos do slide (clique direito no elemento -&gt; Conectar dados).</li>
                            </ol>
                        </div>
                    </div>
