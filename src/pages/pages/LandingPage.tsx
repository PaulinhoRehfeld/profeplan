...
import {
    ...
    ArrowRight, Menu, Play, Star, ShieldCheck, Users
} from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20 items-center relative z-10">
                    ...
                    <div className="text-center md:text-left space-y-8 animate-in slide-in-from-bottom-10 fade-in duration-700">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
                            <Link
                                to="/signup"
                                className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-2xl shadow-xl shadow-blue-600/20 text-lg flex items-center justify-center gap-3 transition-all hover:scale-105"
                            >
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-4 pt-4">
                            ...
                            <div className="text-sm font-medium text-slate-500">
                                <span className="font-bold text-slate-900">+5.000</span> professores usam
                            </div>
                        </div>
                    </div>
