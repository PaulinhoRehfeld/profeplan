...
export class AgentHistoria extends BaseDisciplineAgent {
  ...
  public getHabilidadesPrioritarias(): string[] {
    if (this.context.nivel.startsWith('EF_')) {
      return [
        // 6º ano
        'EF06HI01', 'EF06HI02', 'EF06HI03', 'EF06HI04', 'EF06HI05',
        'EF06HI06', 'EF06HI07', 'EF06HI08',
        // 7º ano
        'EF07HI01', 'EF07HI02', 'EF07HI03', 'EF07HI04', 'EF07HI05',
        'EF07HI06', 'EF07HI07', 'EF07HI08',
        // 8º ano
        'EF08HI01', 'EF08HI02', 'EF08HI03', 'EF08HI04', 'EF08HI05',
        'EF08HI06', 'EF08HI07', 'EF08HI08',
        // 9º ano
        'EF09HI01', 'EF09HI02', 'EF09HI03', 'EF09HI04', 'EF09HI05',
        'EF09HI06', 'EF09HI07', 'EF09HI08',
      ];
    }
    return [
  ...
  protected async _callLLM(
    ...
    return JSON.stringify({
      ...
      resposta_mock: `[MOCK] Conteúdo gerado por Heródoto (História) para ${params.tema || 'tema não especificado'}.`,
    });
  }
  ...
  private _loadPrompt(filename: string): string {
    ...
    return `[PROMPT: ${filename}] Conteúdo do prompt para História.`;
  }
}
