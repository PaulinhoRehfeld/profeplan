...
export class AgentCienciasBiologia extends BaseDisciplineAgent {
  ...
  protected async _callLLM(
    ...
    return JSON.stringify({
      ...
      resposta_mock: `[MOCK] Conteúdo gerado por Darwin (Ciências/Biologia) para ${params.tema || 'tema não especificado'}.`,
    });
  }
  ...
  private _loadPrompt(filename: string): string {
    ...
    return `[PROMPT: ${filename}] Conteúdo do prompt para Ciências/Biologia.`;
  }
}
