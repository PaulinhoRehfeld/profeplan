import type { AuditRepository, DomainEvent } from '@profeplan/knowledge-factory';
...
export class SupabaseAuditRepository implements AuditRepository {
  ...
  async listByAggregate(aggregateId: EntityId): Promise<readonly DomainEvent[]> {
    ...
    try {
      ...
      const events = response.data.map((row) => auditRowToDomainEvent(row, operation));
      recordSuccess(
        this.logger,
        this.context,
        operation,
