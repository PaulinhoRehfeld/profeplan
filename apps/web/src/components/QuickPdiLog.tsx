...
const QuickPdiLog: React.FC<QuickPdiLogProps> = ({
  studentId,
  studentName,
  onClose,
  onSuccess,
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-white p-6 rounded-2xl w-full max-w-md shadow-2xl relative">
        ...
        <h3 className="text-lg font-black text-slate-800 mb-1 uppercase italic tracking-tight">
          Registro Rápido
        </h3>
        <p className="text-sm font-bold text-slate-400 uppercase tracking-wide mb-6">
          Para: {studentName}
        </p>
        ...
        <textarea
          ...
          placeholder={
            type === 'OCCURRENCE' ? 'Descreva o comportamento...' : 'Descreva a observação...'
          }
          value={description}
