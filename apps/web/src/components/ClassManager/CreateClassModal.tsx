    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="mb-4">
            ...
            <p className="text-[9px] text-center text-indigo-400 mt-2 font-bold uppercase tracking-wide">
              Busque alunos já cadastrados na sua instituição
            </p>
          </div>

          <div className="relative flex py-2 items-center">
            <div className="flex-grow border-t border-slate-100"></div>
            <span className="flex-shrink-0 mx-4 text-xs font-bold text-slate-300 uppercase">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 mb-2">
              Cole os nomes abaixo (um por linha ou separados por vírgula).
            </p>
            <textarea
      ...
      {isSchoolImportOpen && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[10000] flex items-center justify-center p-4">
          <div
            className="w-full max-w-lg h-[600px] bg-white rounded-3xl overflow-hidden relative"
            onClick={(e) => e.stopPropagation()}
          >
