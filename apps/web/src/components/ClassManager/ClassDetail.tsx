...
const ClassDetail: React.FC<ClassDetailProps> = ({ selectedClass, onClose, onUpdateStudent }) => {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">
            {selectedClass.subject} • {selectedClass.students?.length || 0} Alunos
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-100 rounded-[2.5rem] shadow-sm overflow-hidden flex flex-col md:flex-row">
        <div className="flex-1">
          <div className="p-8 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
            <h3 className="font-black text-[10px] uppercase tracking-[0.2em] text-slate-400 italic">
                    ...
                    >
                      ...
                      <td className="px-10 py-5">
                        ...
                        {student.pedagogical_observations &&
                          student.pedagogical_observations.trim().length > 0 && (
