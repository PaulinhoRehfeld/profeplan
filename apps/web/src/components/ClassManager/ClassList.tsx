  ...
  if (!loading && filteredClasses.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center text-slate-400">
        ...
        <p className="font-black text-xs uppercase tracking-[0.25em] mb-2">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-slate-50 relative z-10">
              <div className="flex flex-col">
                ...
                <p className="text-lg font-black text-slate-900 italic">
                  {(cls as any).students?.[0]?.count || (cls as any).students?.length || 0}
                </p>
              </div>
              <button className="px-6 py-3 bg-slate-50 text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all flex items-center gap-2 group/btn">
                Ver Alunos{' '}
                <ChevronRight
                  size={14}
