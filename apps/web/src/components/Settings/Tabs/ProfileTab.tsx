...
export const ProfileTab: React.FC<ProfileTabProps> = ({
  ...
  console.log(
    '[ProfileTab] Incoming Profile Data:',
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (!userId) {
        console.warn(
          '[ProfileTab] userProfile.id not available, attempting fallback to session...'
        );
        try {
      ...
      if (!userId) {
        alert(
          '⚠️ Não foi possível identificar seu usuário. Por favor, saia e entre novamente.\n\nSe o problema persistir, limpe o cache do navegador.'
        );
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              type="email"
              value={localSettings.institutionalEmail || ''}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <p className="text-[10px] text-slate-500 ml-1">
                Matrícula SIAFI (7 dígitos + verificador)
              </p>
            </div>
          </div>
              ...
              >
                {localSettings.logoBase64 ? (
                  ...
                  <>
                    ...
                    <span className="text-[8px] font-black text-slate-400 uppercase text-center px-2">
                      Subir Logo (PNG/JPG)
                    </span>
                  </>
                )}
