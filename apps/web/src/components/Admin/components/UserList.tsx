                                ...
                                <td className="px-3 md:px-6 py-4 text-center">
                                    {editingUser?.id === user.id ? (
                                        <div className="flex items-center justify-center gap-2">
                                            <button onClick={() => onUpdateUser(user.id, { tier: editingUser.tier, credits: editingUser.credits, is_unlimited: editingUser.tier === 'GOLD' })} className="p-1.5 bg-green-100 text-green-700 rounded hover:bg-green-200"><Check size={16} /></button>
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            {!user.is_admin && (
                                                <button onClick={() => onDeleteUser(user)} className="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded transition" title="Excluir">
                                                    <Trash2 size={16} />
                                                </button>
                                            )}
