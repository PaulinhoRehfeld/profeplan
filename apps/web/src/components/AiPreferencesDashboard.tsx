      ...
      <div className="bg-gradient-to-br from-slate-50 to-slate-100 border-2 border-slate-200 rounded-xl p-4 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="flex items-center gap-2">
            {React.createElement(getMethodologyIcon(preferences.methodology), {
    ...
    <div className="bg-gradient-to-br from-white to-slate-50 border-2 border-slate-200 rounded-2xl p-6 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-shadow">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            {preferences.methodology.includes('Gamif') &&
              'Elementos de jogos, desafios e narrativas envolventes'}
            {preferences.methodology.includes('Problem') &&
              'Problemas reais, investigação e descoberta autônoma'}
            {preferences.methodology === 'Traditional' &&
              'Estrutura clara, exposição e exercícios de fixação'}
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-shadow">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            {preferences.pedagogicalStyle === 'Construtivista' &&
              'Aluno constrói conhecimento, experimentação e mediação'}
            {preferences.pedagogicalStyle === 'Sociointeracionista' &&
              'Aprendizagem via interação social e colaboração'}
            {preferences.pedagogicalStyle === 'Tradicional' &&
              'Professor transmite, disciplina e sequência rigorosa'}
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-shadow">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            {preferences.assessmentFocus === 'Formativa' &&
              'Avaliação durante o processo, feedback contínuo'}
            {preferences.assessmentFocus === 'Somativa' &&
              'Avaliação ao final, mensuração e classificação'}
            {preferences.assessmentFocus === 'Diagnóstica' &&
              'Avaliação antes do início, mapeamento de conhecimentos'}
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-shadow">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            {preferences.writingTone.includes('Prático') &&
              'Linguagem acessível, exemplos reais e tom motivador'}
            {preferences.writingTone.includes('Técnico') &&
              'Terminologia pedagógica, formal e referenciado'}
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-100 rounded-xl">
        <p className="text-xs text-blue-800 leading-relaxed">
          ...
          Planejamentos, PDIs, Avaliações e Chat IA. Seu feedback sempre pode sobrescrever estas
          configurações.
        </p>
      </div>
    </div>
