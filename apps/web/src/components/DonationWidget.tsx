    ...
    <div className="bg-white border-2 border-slate-100 rounded-3xl p-5 flex flex-col items-center text-center shadow-sm w-full mx-auto my-4 animate-in fade-in slide-in-from-bottom-2 duration-500 group">
      ...
      >
        <div className="flex flex-col items-center">
          <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 group-hover/pix:text-blue-600 transition-colors">
            Chave Celular
          </span>
        ...
        <div
          className={`w-full py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all ${copied ? 'bg-green-500 text-white shadow-lg shadow-green-200' : 'bg-blue-600 text-white shadow-lg shadow-blue-100'}`}
        >
