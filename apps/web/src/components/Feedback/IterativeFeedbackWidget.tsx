...
import { MessageCircle, Send, CheckCircle2, XCircle, Sparkles, Loader2, Settings } from 'lucide-react';
...
export const IterativeFeedbackWidget: React.FC<IterativeFeedbackWidgetProps> = ({
    ...
    const [currentStep, setCurrentStep] = useState<'feedback' | 'confirmation' | 'preference'>('feedback');
                ...
                {isRegenerating && (
                    <div className="flex flex-col items-center justify-center py-8 text-center">
                        ...
                        <p className="text-xs text-slate-500 max-w-xs">
                            Acatando suas observações: "<span className="font-semibold text-indigo-600">{accumulatedFeedback[accumulatedFeedback.length - 1]}</span>"
                        </p>
                    </div>
                )}
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            >
                                <XCircle size={18} />
                                NÃO
                                <span className="block text-[10px] font-normal text-red-600">Precisa ajustar mais</span>
                            </button>
                            <button
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                >
                                    NÃO
                                    <span className="block text-[10px] font-normal text-slate-600">Apenas este plano</span>
                                </button>
                                <button
                                ...
                                >
                                    SIM
                                    <span className="block text-[10px] font-normal text-purple-100">Usar como padrão</span>
                                </button>
                            </div>
