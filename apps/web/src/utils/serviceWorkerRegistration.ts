...
export const registerServiceWorker = async (): Promise<ServiceWorkerRegistration | null> => {
  console.warn(
    '[SW Registration] registerServiceWorker é legado – o SW é gerenciado pelo VitePWA/ReloadPrompt. Nenhuma ação realizada.'
  );
  return null;
};
 ...
 */
export const setupOnlineStatusListeners = (onOnline?: () => void, onOffline?: () => void): void => {
