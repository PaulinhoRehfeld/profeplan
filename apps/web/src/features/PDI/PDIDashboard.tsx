...
const PDIDashboard: React.FC<PDIDashboardProps> = ({ schoolId, userId }) => {
  ...
  const loadAnalytics = async () => {
    ...
    try {
      ...
      const completenesses = pdis.map(
        (p) => PdiDocumentService.calculateCompleteness(p).overall_percentage
      );
      const media_completude =
        completenesses.length > 0
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <button onClick={loadAnalytics} className="px-6 py-2 bg-blue-600 text-white rounded-xl">
            Tentar Novamente
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-black text-slate-900 mb-2">Dashboard PDI</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-4xl font-black text-slate-900 mb-1">{analytics.total_pdis}</div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-4xl font-black text-slate-900 mb-1">{analytics.em_andamento}</div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-4xl font-black text-slate-900 mb-1">{analytics.finalizados}</div>
          ...
          <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl p-6 text-white hover:shadow-lg transition-shadow">
            ...
            <div className="text-4xl font-black mb-1">{analytics.media_completude}%</div>
              ...
              <div className="p-4 bg-blue-50 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-900">
                    <strong>Lembrete:</strong> Acompanhe regularmente o progresso dos PDIs e
                    mantenha os registros atualizados para garantir o melhor suporte aos estudantes.
                  </div>
                </div>
              </div>
            </div>
