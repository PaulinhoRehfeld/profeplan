      ...
      <div className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm print:hidden">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-black text-slate-900">PDI Completo - {studentName}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
        ...
        <div className="hidden print:block page-break-after">
          <div className="text-center space-y-6 py-20">
            ...
            <h2 className="text-3xl font-bold text-slate-700">{studentName}</h2>
            <p className="text-xl text-slate-600">Ano: {pdi.year}</p>
        ...
        <section className="page-break-before">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-black text-slate-900">Bloco 9: Adaptações Curriculares</h2>
          </div>
        ...
        <section className="page-break-before">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-black text-slate-900">Bloco 11: Relatório Final</h2>
          </div>
          <PDIBlock11Editor
            pdiId={pdiId}
        ...
        <section className="hidden print:block page-break-before">
          <div className="mt-20 space-y-16">
            <div>
              ...
              <p className="text-center text-sm text-slate-500">Data: _____ / _____ / _____</p>
            </div>
            <div>
              <div className="border-t-2 border-slate-900 w-96 mx-auto"></div>
              <p className="text-center mt-2 font-bold text-slate-700">Professor Responsável</p>
              <p className="text-center text-sm text-slate-500">Data: _____ / _____ / _____</p>
            </div>
            <div>
              <div className="border-t-2 border-slate-900 w-96 mx-auto"></div>
