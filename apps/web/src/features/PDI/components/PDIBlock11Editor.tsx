    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-emerald-100 text-sm">Documento oficial de encerramento do PDI</p>
            </div>
          </div>
          {isApproved && (
      ...
      {!canEdit && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="text-sm text-yellow-900">
            <strong>Modo Visualização:</strong> Apenas gestores escolares podem gerar e editar o
            relatório final.
          </div>
        </div>
      )}
      ...
      {!hasReport && canEdit && !isApproved && (
        <div className="bg-white rounded-2xl border-2 border-dashed border-slate-300 p-12 text-center">
          ...
          <h4 className="text-xl font-bold text-slate-900 mb-2">Relatório Final Não Gerado</h4>
          <p className="text-slate-600 max-w-md mx-auto mb-6">
            Clique no botão abaixo para que a IA gere o relatório final consolidando todos os blocos
            anteriores do PDI.
          </p>
          <button
