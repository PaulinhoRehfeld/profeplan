  ...
  if (adaptations.length === 0) {
    return (
      <div className="bg-slate-50 border-2 border-dashed border-slate-300 rounded-2xl p-12 text-center">
        ...
        <h3 className="text-xl font-bold text-slate-900 mb-2">Nenhuma Adaptação Gerada Ainda</h3>
        <p className="text-slate-600 max-w-md mx-auto">
          As adaptações curriculares serão geradas automaticamente quando o professor salvar novos
