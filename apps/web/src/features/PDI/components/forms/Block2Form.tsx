...
export const Block2Form: React.FC<{
  block2: Block2Diagnostico;
  setBlock2: (b: Block2Diagnostico) => void;
}> = ({ block2, setBlock2 }) => (
  <>
    ...
    <div className="space-y-6">
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock2({
              ...block2,
              necessidades_especificas: e.target.value.split('\n').filter(Boolean),
            })
          }
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock2({ ...block2, potencialidades: e.target.value.split('\n').filter(Boolean) })
          }
          className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 h-32 resize-none"
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock2({ ...block2, desafios: e.target.value.split('\n').filter(Boolean) })
          }
          className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 h-32 resize-none"
