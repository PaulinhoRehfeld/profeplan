...
export const Block4Form: React.FC<{
  block4: Block4Recursos;
  setBlock4: (b: Block4Recursos) => void;
}> = ({ block4, setBlock4 }) => (
  <>
    ...
    <div className="space-y-6">
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock4({
              ...block4,
              recursos_tecnologicos: e.target.value.split('\n').filter(Boolean),
            })
          }
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock4({
              ...block4,
              materiais_adaptados: e.target.value.split('\n').filter(Boolean),
            })
          }
          className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 h-32 resize-none"
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock4({ ...block4, equipamentos: e.target.value.split('\n').filter(Boolean) })
          }
          className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 h-32 resize-none"
