...
export const Block6Form: React.FC<{
  block6: Block6Atendimento;
  setBlock6: (b: Block6Atendimento) => void;
}> = ({ block6, setBlock6 }) => (
  <>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock6({ ...block6, responsaveis: e.target.value.split('\n').filter(Boolean) })
          }
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setBlock6({ ...block6, tipo_atendimento: e.target.value.split('\n').filter(Boolean) })
          }
          className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 h-24 resize-none"
