      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
          ...
          <div className="space-y-6">
            ...
            {currentStep === 0 && <Block1Form block1={block1} setBlock1={setBlock1} />}

            {/* Block 2: Diagnóstico */}
            {currentStep === 1 && <Block2Form block2={block2} setBlock2={setBlock2} />}

            {/* Block 3: Objetivos */}
            {currentStep === 2 && <Block3Form block3={block3} setBlock3={setBlock3} />}

            {/* Block 4: Recursos */}
            {currentStep === 3 && <Block4Form block4={block4} setBlock4={setBlock4} />}

            {/* Block 5: Equipe */}
            {currentStep === 4 && <Block5Form block5={block5} setBlock5={setBlock5} />}

            {/* Block 6: Atendimento */}
            {currentStep === 5 && <Block6Form block6={block6} setBlock6={setBlock6} />}

            {/* Block 7: Família */}
            {currentStep === 6 && <Block7Form block7={block7} setBlock7={setBlock7} />}

            {/* Block 8: Observações */}
            {currentStep === 7 && <Block8Form block8={block8} setBlock8={setBlock8} />}
          </div>
