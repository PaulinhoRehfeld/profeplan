...
export const AdaptationFeedbackModal: React.FC<AdaptationFeedbackModalProps> = ({
  ...
  const [development, setDevelopment] = useState<
    'PLENAMENTE' | 'PARCIALMENTE' | 'NAO_DESENVOLVIDA' | ''
  >('');
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-2">
              {[
                {
                  val: 'PLENAMENTE',
                  label: 'Plenamente Desenvolvida',
                  color: 'border-emerald-200 bg-emerald-50 text-emerald-700',
                },
                {
                  val: 'PARCIALMENTE',
                  label: 'Parcialmente Desenvolvida',
                  color: 'border-yellow-200 bg-yellow-50 text-yellow-700',
                },
                {
                  val: 'NAO_DESENVOLVIDA',
                  label: 'Não Desenvolvida',
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                >
                  ...
                  />
                  <span
                    className={`text-xs font-bold ${support === opt.val ? 'text-indigo-700' : 'text-slate-400'}`}
                  >
                    {opt.label}
                  </span>
