        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 space-y-8">
          <section>
            ...
            <p className="leading-relaxed">
              A sua privacidade é importante para nós. É política do ProfePlan respeitar a sua
              privacidade em relação a qualquer informação sua que possamos coletar no site
              ProfePlan, e outros sites que possuímos e operamos.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              exceto quando exigido por lei. Nosso site pode ter links para sites externos que não
              são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Utilizamos cookies para analisar o tráfego do site e otimizar sua experiência. Você é
              livre para recusar a nossa solicitação de informações pessoais, entendendo que talvez
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              ...
              ProfePlan oferece no site e com caráter enunciativo, mas não limitativo:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li>
                ...
                ProfePlan, de seus fornecedores ou terceiros.
              </li>
            </ul>
          </section>
