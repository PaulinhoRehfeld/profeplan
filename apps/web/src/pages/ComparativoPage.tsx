  ...
  const dimensions: CompareDimension[] = [
    {
      ...
      v4Content:
        'Repositório de documentação, especificações de produto, modelos de dados e arquitetura. Sem código operacional direto.',
      v5Content:
        'Repositório operacional consolidado da versão 5.0 contendo o código executável dos novos microsserviços e apps.',
      impact:
        'Separação clara entre a base conceitual/histórica (V4) e a evolução do código em produção (V5).',
      category: 'produto',
    },
    {
      id: 'negocio',
      ...
      v4Content:
        'Validação de MVP focado principalmente nos professores da rede pública de Minas Gerais (SEE/MG).',
      v5Content:
        'Arquitetura modularizada escalável B2G preparada para adoção nacional (qualquer secretaria de educação do Brasil).',
      impact:
        'Escalabilidade comercial e capacidade de plugar regras curriculares de outros estados dinamicamente.',
      category: 'negocio',
    },
    {
      id: 'arquitetura',
      ...
      v4Content:
        'Monorepo Industrial dividido entre a Loja (React/Vite Frontend) e Indústrias offline (pipelines batch em Python).',
      v5Content:
        'Evolução para microsserviços integrados de forma síncrona/assíncrona, simplificando o monorepo local.',
      impact:
        'Redução drástica no tempo de resposta e facilidade para implantar melhorias pontuais sem afetar o app inteiro.',
    ...
    },
    {
      ...
      v4Content:
        'Uso de Azure OpenAI (geração de texto) e Google Gemini (embeddings de 768 dimensões) operando isoladamente.',
      v5Content:
        'Orquestração de agentes autônomos (Agente Planejador + Didático + Avaliador) trabalhando em cadeia via Azure.',
      impact:
        'Gerações com fidelidade curricular absoluta, zero alucinação da BNCC e otimização do custo por token.',
      category: 'ia',
    },
    {
      id: 'pdi',
      ...
      v4Content:
        'Adaptação reativa baseada nas observações do perfil de alunos laudados ou com dificuldades anotadas.',
      v5Content:
        'Motor de PDI automatizado integrado ao planejamento macro, sugerindo adaptações metodológicas no fluxo diário.',
      impact:
        'Atendimento aos requisitos legais e forte apelo pedagógico-social em licitações públicas.',
      category: 'produto',
    },
    {
      id: 'seguranca',
      ...
      v4Content:
        'OAuth secundário e Supabase Auth isolado para contornar bloqueios das redes de internet governamentais.',
      v5Content:
        'Arquitetura de segurança federada reforçada, com políticas rígidas de RLS e autenticação adaptativa.',
      impact:
        'Blindagem de dados dos alunos e professores contra vulnerabilidades comuns e auditoria B2G facilitada.',
      category: 'arquitetura',
    },
  ];
  ...
  const timelinePhases = [
    {
      ...
      description:
        'Modelagem do banco de dados inicial, processamento dos currículos locais e testes iniciais de aceitação dos professores.',
    },
    {
      phase: 2,
      ...
      color: 'bg-emerald-500',
      description:
        'Estruturação do monorepo operacional separando Frontend (Loja) e pipelines Python (Indústrias BNCC/PNLD).',
    },
    {
      phase: 3,
    ...
    },
    {
      ...
      color: 'bg-blue-500',
      description:
        'Migração completa de infraestrutura para ambiente de alta disponibilidade e lançamento do motor multi-agente nacional.',
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-10">
        ...
        <header className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 md:p-12 rounded-3xl relative overflow-hidden shadow-2xl">
          ...
          <p className="text-base md:text-xl text-slate-400 max-w-4xl leading-relaxed border-t border-white/10 pt-6">
            Comparativo de alto nível entre os repositórios **V4** (Estado Atual Operacional) e
            **V5** (Nova Geração de Escala Nacional). Preparado para integração rápida de membros da
            equipe e apresentação para stakeholders.
          </p>
        </header>
              ...
              {selectedArchTab === 'v4' ? (
                ...
                <div className="flex flex-col gap-10 relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    >
                      <div className="flex items-center gap-3 mb-4 border-b border-white/10 pb-3">
                        ...
                        <span className="font-bold text-sm md:text-lg text-white uppercase">
                          1. Indústrias (Offline)
                        </span>
                      </div>
                      <p className="text-sm md:text-base text-slate-400 mb-4 leading-relaxed">
                        Pipelines Python que processam BNCC e PNLD em lotes offline de forma
                        noturna.
                      </p>
                      <span className="inline-block text-xs bg-white/10 text-slate-300 border border-white/10 px-3 py-1 rounded-md font-bold uppercase">
                        Python / Gemini
                      </span>
                    </div>
                  ...
                  <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6 flex flex-col md:flex-row justify-around items-center gap-6 text-sm md:text-base font-bold">
                    <span className="flex items-center gap-2 text-amber-400">
                      Indústrias <ArrowRight className="w-5 h-5" /> Envia Dados Limpos{' '}
                      <ArrowRight className="w-5 h-5" /> Supabase
                    </span>
                    <span className="flex items-center gap-2 text-emerald-400">
                      Supabase <ArrowRight className="w-5 h-5" /> Consumo Rápido JIT{' '}
                      <ArrowRight className="w-5 h-5" /> Frontend Loja
                    </span>
                  </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 rounded-2xl p-6 flex gap-4 items-start">
                    ...
                    <div className="text-sm md:text-lg leading-relaxed text-slate-300">
                      <strong>Funcionamento Hoje:</strong> O processamento dos dados educacionais
                      pesados acontece fora do servidor de aplicação principal. O professor interage
                      com uma aplicação leve que consome os dados já estruturados e validados no
                      banco de dados.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-10 relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-between min-h-[220px]">
                      <div>
                        ...
                        <p className="text-sm md:text-base text-slate-400 leading-relaxed mb-6">
                          Agentes integrados (Planejador + Avaliador) gerando planejamentos
                          didáticos síncronos e integrados.
                        </p>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        <span className="text-xs bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 px-3 py-1 rounded-md font-bold uppercase">
                          Azure OpenAI
                        </span>
                        <span className="text-xs bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 px-3 py-1 rounded-md font-bold uppercase">
                          Multi-Agente
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-between min-h-[220px]">
                      <div>
                        ...
                        <p className="text-sm md:text-base text-slate-400 leading-relaxed mb-6">
                          Infraestrutura unificada. O módulo de Inclusão (PDI/DUA) é parte nativa do
                          fluxo principal de planejamento.
                        </p>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        <span className="text-xs bg-orange-500/10 text-orange-300 border border-orange-500/20 px-3 py-1 rounded-md font-bold uppercase">
                          Node/Go API
                        </span>
                        <span className="text-xs bg-orange-500/10 text-orange-300 border border-orange-500/20 px-3 py-1 rounded-md font-bold uppercase">
                          Sincronismo
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-between min-h-[220px]">
                      <div>
                        ...
                        <p className="text-sm md:text-base text-slate-400 leading-relaxed mb-6">
                          Carregamento dinâmico de diretrizes curriculares estaduais ou municipais
                          para todo o Brasil.
                        </p>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        <span className="text-xs bg-blue-500/10 text-blue-300 border border-blue-500/20 px-3 py-1 rounded-md font-bold uppercase">
                          B2G Escala
                        </span>
                        <span className="text-xs bg-blue-500/10 text-blue-300 border border-blue-500/20 px-3 py-1 rounded-md font-bold uppercase">
                          Nacional
                  ...
                  <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-6 flex items-start gap-4">
                    ...
                    <div className="text-sm md:text-lg leading-relaxed text-slate-300">
                      <strong>Meta da Versão 5:</strong> A plataforma deixa de ser regional para
                      atender redes educacionais nacionais. O fluxo de geração de planos agora
                      incorpora inteligência adaptativa de acessibilidade (DUA) de ponta a ponta sem
                      delays.
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-3xl shadow-2xl">
              ...
              {timelinePhases.map((phase, idx) => (
                ...
                >
                  <div>
                    ...
                    <h4 className="font-bold text-sm md:text-lg text-white uppercase leading-tight">
                      {phase.title}
                    </h4>
                  </div>
                  <span className="text-xs font-bold text-blue-400 mt-6 border-t border-white/5 pt-3 block">
                    VER DETALHES →
                  </span>
                </button>
              ))}
            ...
            <div className="mt-8 bg-white/[0.02] border border-white/10 rounded-2xl p-6">
              <h4 className="font-bold text-lg md:text-xl text-white uppercase mb-2 flex items-center gap-3">
                <span className="bg-blue-600 text-white text-xs md:text-sm px-3 py-1 rounded-full">
                  FASE {timelinePhases[selectedTimelinePhase].phase}
                </span>
        ...
        <section className="w-full">
          <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-3xl shadow-2xl">
            ...
            <p className="text-sm md:text-lg text-slate-400 mb-6 leading-relaxed">
              Selecione uma dimensão abaixo para inspecionar e comparar as mudanças conceituais
              detalhadas:
            </p>
              ...
              {dimensions.map((dim) => (
                <div key={dim.id} className="flex flex-col">
                  ...
                  >
                    ...
                    <ChevronRight
                      className={`w-6 h-6 text-slate-400 transition-transform ${activeCardId === dim.id ? 'rotate-90 text-white' : ''}`}
                    />
                  </button>
                  ...
                  {activeCardId === dim.id && (
                    <div className="border-x border-b border-white/10 rounded-b-2xl p-6 bg-slate-950/40 flex flex-col md:flex-row gap-6 text-sm md:text-lg leading-relaxed animate-fadeIn">
                      <div className="flex-1 border-b md:border-b-0 md:border-r border-white/10 pb-4 md:pb-0 md:pr-6">
                        <strong className="text-xs md:text-sm text-slate-500 uppercase block tracking-wider mb-2">
                          Estado Atual (V4)
                        </strong>
                        <p className="text-slate-300">{dim.v4Content}</p>
                      </div>
                      <div className="flex-1 border-b md:border-b-0 md:border-r border-white/10 pb-4 md:pb-0 md:pr-6">
                        <strong className="text-xs md:text-sm text-blue-400 uppercase block tracking-wider mb-2">
                          Alvo Planejado (V5)
                        </strong>
                        <p className="text-white font-bold">{dim.v5Content}</p>
                      </div>
                      <div className="flex-1">
                        <strong className="text-xs md:text-sm text-amber-400 uppercase block tracking-wider mb-2">
                          Impacto no Alinhamento
                        </strong>
        ...
        <section className="w-full">
          <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            <div className="text-sm md:text-lg space-y-3 font-mono text-slate-300 leading-relaxed border-t border-white/10 pt-4">
              <p>
                📍 <strong>Localização:</strong> apps/web
              </p>
              <p>
              ...
              <p className="text-blue-400">
                ...
                para guiar a equipe e demonstrar visualmente onde o PROFEPLAN está e onde ele irá
                pousar na versão 5.
              </p>
            </div>
          </div>
