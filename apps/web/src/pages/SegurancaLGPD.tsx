...
const SegurancaLGPD: React.FC = () => (
  <LegalLayout title="Segurança, Privacidade e LGPD">
    <section>
      <p>
        A <strong>WR TECH INOVA SIMPLES (I.S.)</strong> busca incorporar privacidade e segurança ao
        desenvolvimento do ProfePlan.
      </p>
      ...
      <p>
        Não declaramos medidas específicas que não estejam comprovadas tecnicamente na infraestrutura
        atual.
      </p>
      <p>
        Não afirmamos possuir certificações como ISO 27001, SOC 2 ou equivalentes sem a devida
        comprovação.
      </p>
