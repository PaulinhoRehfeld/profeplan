        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 space-y-8">
          <section>
            ...
            <p className="leading-relaxed">
              Ao acessar ao site <span className="font-bold">ProfePlan</span>, concorda em cumprir
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              ...
              ou software) no site ProfePlan , apenas para visualização transitória pessoal e não
            ...
            <p className="leading-relaxed mt-4">
              ...
              poderá ser rescindida por ProfePlan a qualquer momento. Ao encerrar a visualização
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              Os materiais no site da ProfePlan são fornecidos 'como estão'. ProfePlan não oferece
            ...
            <p className="leading-relaxed">
              Além disso, o ProfePlan não garante ou faz qualquer representação relativa à precisão,
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Em nenhum caso o ProfePlan ou seus fornecedores serão responsáveis por quaisquer danos
              (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção
              dos negócios) decorrentes do uso ou da incapacidade de usar os materiais em ProfePlan,
              mesmo que ProfePlan ou um representante autorizado da ProfePlan tenha sido notificado
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Os materiais exibidos no site da ProfePlan podem incluir erros técnicos, tipográficos
              ou fotográficos. ProfePlan não garante que qualquer material em seu site seja preciso,
              completo ou atual. ProfePlan pode fazer alterações nos materiais contidos em seu site
              a qualquer momento, sem aviso prévio. No entanto, ProfePlan não se compromete a
          ...
          <section>
            ...
            <p className="leading-relaxed">
              O ProfePlan não analisou todos os sites vinculados ao seu site e não é responsável
              pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica
              endosso por ProfePlan do site. O uso de qualquer site vinculado é por conta e risco do
              usuário.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              O ProfePlan pode revisar estes termos de serviço do site a qualquer momento, sem aviso
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              ProfePlan e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais
