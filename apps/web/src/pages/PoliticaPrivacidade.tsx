...
const PoliticaPrivacidade: React.FC = () => (
  ...
  >
    <section>
      ...
      <p>Esta Política de Privacidade explica como os dados pessoais podem ser tratados durante o acesso à landing page, a criação de uma conta, a utilização da plataforma, a contratação de planos, o contato com o suporte e o uso das ferramentas pedagógicas e de inteligência artificial disponibilizadas pelo ProfePlan.</p>
      <p>O ProfePlan é um produto digital desenvolvido e operado por <strong>WR TECH INOVA SIMPLES (I.S.)</strong>, inscrita no CNPJ sob o nº <strong>65.458.067/0001-10</strong>, com sede na Rua Varginha, nº 92, Bairro Planalto, Capelinha, Minas Gerais, CEP 39682-036, Brasil.</p>
      <p>Para assuntos relacionados à privacidade e à proteção de dados, o contato deverá ser realizado pelo e-mail <a href="mailto:suporte@profeplan.com.br">suporte@profeplan.com.br</a>.</p>
    </section>
    ...
    <section>
      ...
      <p>A plataforma é direcionada principalmente a professores, gestores e outros profissionais adultos da educação.</p>
      <p>Nesta versão do produto, o ProfePlan não é apresentado como uma plataforma destinada à criação direta de contas por crianças ou adolescentes.</p>
    </section>

    <section>
      <h2>3. Papéis no tratamento de dados</h2>
      <p>A <strong>WR TECH INOVA SIMPLES (I.S.)</strong> atua como controladora dos dados pessoais relacionados a:</p>
      <ul>
        <li>visitantes da landing page;</li>
      ...
      <p>Quando professores ou instituições inserem dados educacionais de estudantes, a definição dos papéis dependerá do contexto de utilização.</p>
      <p>Em contratações institucionais, a escola, rede de ensino ou instituição contratante poderá atuar como controladora dos dados educacionais, enquanto a WR TECH INOVA SIMPLES (I.S.) poderá atuar como operadora, tratando os dados conforme as instruções da instituição e os contratos aplicáveis.</p>
      <p>No uso individual, o usuário deve possuir autorização, competência profissional ou outra base legal válida para inserir informações de terceiros na plataforma.</p>
    </section>
    ...
    <section>
      ...
      <ul>
        <li>nome;</li>
        <li>e-mail;</li>
        <li>senha armazenada de forma protegida ou credencial gerenciada pelo provedor de autenticação;</li>
      ...
      <p>Os dados completos do cartão devem ser processados pelo provedor de pagamentos utilizado pela plataforma.</p>
      <p>O ProfePlan não deve armazenar o número completo do cartão, o código de segurança ou credenciais bancárias completas em seu próprio banco de dados.</p>
      ...
      <p>Os usuários devem priorizar o uso de iniciais, códigos internos, pseudônimos ou outras formas de identificação reduzida sempre que o nome completo não for indispensável.</p>

      <h3>4.7. Dados pessoais sensíveis</h3>
      <p>Algumas informações educacionais poderão revelar dados sensíveis, principalmente quando relacionadas a:</p>
      <ul>
        <li>saúde;</li>
        <li>deficiência;</li>
      ...
      <p>Esses dados somente devem ser inseridos quando forem estritamente necessários, adequados à finalidade pedagógica e amparados por base legal válida.</p>
      <p>O ProfePlan não deve ser utilizado como repositório indiscriminado de prontuários, laudos médicos ou documentos clínicos completos.</p>
    </section>
    ...
    <section>
      ...
      <p>Conforme a finalidade e a categoria dos dados, o tratamento poderá estar fundamentado em:</p>
      <ul>
      ...
      <p>No tratamento de dados de crianças e adolescentes, deverá prevalecer o seu melhor interesse.</p>
      <p>A Política de Privacidade não deve ser utilizada como uma autorização genérica para qualquer tratamento.</p>
      <p>Quando o consentimento for realmente necessário, ele deverá ser solicitado de forma específica, destacada, livre e informada.</p>
    </section>

    <section>
      <h2>7. Inteligência artificial</h2>
      <p>O ProfePlan utiliza ou poderá utilizar sistemas de inteligência artificial para auxiliar na produção de planejamentos, atividades, avaliações, apresentações, adaptações e outros materiais pedagógicos.</p>
    ...
    <section>
      ...
      <p>Os dados poderão ser compartilhados, dentro dos limites necessários, com categorias de fornecedores como:</p>
      <ul>
      ...
      <p><strong>Fornecedores identificados nesta versão:</strong></p>
      ...
      <p>Não inserir fornecedores fictícios. Esta tabela reflete os provedores confirmados na infraestrutura atual.</p>
    </section>
    ...
    <section>
      ...
      <p>Quando houver transferência internacional de dados pessoais, deverão ser utilizados os mecanismos permitidos pela LGPD e pela regulamentação da Autoridade Nacional de Proteção de Dados.</p>
    ...
    <section>
      ...
      <p>Cookies analíticos, publicitários ou de rastreamento não devem ser carregados antes da manifestação válida do usuário, quando dependerem de consentimento.</p>
      <p>Mais informações estão disponíveis na <Link to="/politica-de-cookies">Política de Cookies</Link>.</p>
    </section>
    ...
    <section>
      ...
      <ul>
        ...
        <li>anonimizados;</li>
        <li>bloqueados;</li>
        <li>mantidos exclusivamente para cumprimento de obrigação legal ou exercício de direitos.</li>
      </ul>
      <p>O encerramento da conta não implica necessariamente a eliminação imediata de todos os registros, pois alguns dados poderão precisar ser preservados pelo prazo legal aplicável.</p>
    </section>

    <section>
      <h2>12. Segurança</h2>
      <p>A WR TECH INOVA SIMPLES (I.S.) adota medidas técnicas e administrativas compatíveis com a natureza dos dados, os riscos envolvidos e o estágio de desenvolvimento do serviço.</p>
      ...
      <p>Nenhum ambiente digital é completamente imune a falhas ou ataques. Esta página não promete segurança absoluta.</p>
    </section>
    ...
    <section>
      ...
      <p>As solicitações poderão ser enviadas para: <a href="mailto:suporte@profeplan.com.br">suporte@profeplan.com.br</a></p>
      <p>A empresa poderá solicitar informações necessárias para confirmar a identidade do requerente e impedir acesso indevido aos dados de terceiros.</p>
    </section>

    <section>
      <h2>14. Crianças e adolescentes</h2>
      <p>O ProfePlan é direcionado a profissionais da educação e não deve incentivar a criação direta de contas por crianças.</p>
      <p>Quando dados de crianças ou adolescentes forem inseridos por professores ou instituições, deverão ser observados:</p>
      <ul>
    ...
    <section>
      ...
      <p>Comunicações necessárias ao funcionamento da conta poderão ser enviadas sem finalidade publicitária, incluindo:</p>
      <ul>
      ...
      <p>Newsletters, promoções e conteúdos comerciais deverão possuir base legal adequada e oferecer opção clara de descadastramento.</p>
    </section>

    <section>
      <h2>16. Incidentes de segurança</h2>
      <p>Caso seja identificado incidente de segurança envolvendo dados pessoais, a empresa realizará avaliação técnica e jurídica e adotará as providências aplicáveis.</p>
      <p>Comunicações aos titulares e à autoridade competente serão realizadas quando exigidas pela legislação.</p>
      <p>Suspeitas de incidente poderão ser comunicadas para: <a href="mailto:suporte@profeplan.com.br">suporte@profeplan.com.br</a></p>
    </section>
    ...
    <section>
      ...
      <p>Rua Varginha, nº 92<br />
      Bairro Planalto<br />
      Capelinha — Minas Gerais<br />
      CEP 39682-036<br />
      Brasil</p>
      <p><strong>Canal de Privacidade e Proteção de Dados:</strong><br />
      <a href="mailto:suporte@profeplan.com.br">suporte@profeplan.com.br</a></p>
    </section>
  </LegalLayout>
);
