...
const DireitosTitular: React.FC = () => (
  <LegalLayout title="Direitos do Titular e Canal de Privacidade">
    <section>
      <h2>Seus direitos</h2>
      <p>A <strong>WR TECH INOVA SIMPLES (I.S.)</strong>, responsável pelo ProfePlan, mantém um canal para solicitações relacionadas a dados pessoais.</p>
    ...
    <section>
      ...
      <p>Enviar e-mail para: <a href="mailto:suporte@profeplan.com.br">suporte@profeplan.com.br</a></p>
      ...
      <p>Não é necessário enviar cópia completa de documento pessoal por padrão. A verificação será proporcional ao risco.</p>
    </section>

    <section>
      <h2>Prazo</h2>
      <p>A solicitação será analisada e respondida dentro dos prazos previstos na legislação e nas normas aplicáveis.</p>
    </section>

    <section>
      <h2>Segurança</h2>
      <p>A empresa poderá solicitar confirmação de identidade para impedir que dados sejam entregues a pessoas não autorizadas.</p>
    </section>

    <section>
      <h2>Solicitações relativas a estudantes</h2>
      <p>Quando a solicitação envolver dados inseridos por uma escola ou professor, poderá ser necessário envolver a instituição responsável.</p>
