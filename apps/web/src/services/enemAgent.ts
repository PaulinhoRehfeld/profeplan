 ...
 */
export const searchEnemQuestions = async (options: EnemSearchOptions): Promise<EnemSearchResult[]> => {
    ...
    try {
        ...
        console.log(`[EnemAgent] Busca: "${query}" → ${scored.length} resultados (de ${candidatas.length} candidatas)`);
        return scored;
