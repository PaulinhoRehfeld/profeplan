...
-- Emergency profile-creation path. The AFTER INSERT profiles trigger above is
-- the single producer of the FREE_TRIAL grant, so normal and recovery paths do
-- not contain duplicated grant logic.
